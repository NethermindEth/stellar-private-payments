...
The exception is `tools/circuit-compiler` which is licensed separately under the GNU General Public License v3.0 (it links iden3 Circom). See `circuits/LICENSE` for details.
