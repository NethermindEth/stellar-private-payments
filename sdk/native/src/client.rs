...
impl<S: Storage> Client<S> {
    ...
    /// sources every envelope, the owner holds the notes. Key derivation is the
    /// one step the owner alone can sign for, and it guards itself — see
    /// [`crate::ensure_signer_is_note_owner`] and
