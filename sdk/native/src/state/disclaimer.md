...
## DEVELOPMENT, LICENSING, AND THE STELLAR NETWORK
This system was developed by Demerzel Solutions Limited (trading as Nethermind) pursuant to an agreement with SDF. SDF does not own, operate, or control the Stellar Network. The source code is licensed under the Apache License, Version 2.0, which governs your rights to use, modify, and distribute the code. This disclaimer governs your access to and use of the hosted demo and supplements (but does not replace) the Apache License. Nethermind hosts this demo for demonstration purposes only and does not operate it as a financial service or assume any operational responsibility beyond hosting.

## NO WARRANTIES
THIS DEMO IS PROVIDED ON AN "AS IS" AND "AS AVAILABLE" BASIS WITHOUT ANY REPRESENTATION OR WARRANTY, WHETHER EXPRESS, IMPLIED, OR STATUTORY. TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, SDF AND NETHERMIND SPECIFICALLY DISCLAIM ANY IMPLIED WARRANTIES OF TITLE, MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. NEITHER SDF NOR NETHERMIND MAKES ANY REPRESENTATIONS OR WARRANTIES THAT ACCESS TO THIS DEMO WILL BE CONTINUOUS, UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE, OR THAT THIS DEMO WILL MEET ANY REGULATORY OR COMPLIANCE NEEDS. THIS DEMO HAS NOT BEEN AUDITED FOR PRODUCTION USE AND MAY CONTAIN SECURITY VULNERABILITIES. DO NOT INPUT SENSITIVE PERSONAL DATA OR PRIVATE KEYS USED ON MAINNET ENVIRONMENTS.

## LIMITATION OF LIABILITY AND INDEMNIFICATION
IN NO EVENT WILL SDF OR NETHERMIND, OR ANY OF THEIR RESPECTIVE DIRECTORS, OFFICERS, EMPLOYEES, OR AGENTS, BE LIABLE FOR ANY DIRECT, INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL, EXEMPLARY, OR PUNITIVE DAMAGES ARISING OUT OF OR IN CONNECTION WITH THIS DEMO, THE STELLAR NETWORK, OR ANY DIGITAL ASSETS, WHETHER SUCH LIABILITY IS ASSERTED ON THE BASIS OF TORT OR OTHERWISE, AND WHETHER OR NOT ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. IF YOU ARE DISSATISFIED WITH THIS DEMO, YOUR SOLE AND EXCLUSIVE REMEDY IS TO DISCONTINUE USE. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF INCIDENTAL OR CONSEQUENTIAL DAMAGES, SO THE ABOVE MAY NOT APPLY TO YOU.

You agree to defend, indemnify, and hold harmless SDF, Nethermind, and their respective directors, employees, and agents from and against any claims, damages, costs, liabilities, and expenses (including reasonable attorneys' fees) arising out of or related to your use of this demo, your violation of this disclaimer, or your use of the Stellar Network or any digital asset.
...
## ACCEPTANCE
By accessing this demo, you confirm that you have read and understood the above, that you meet the eligibility requirements set forth above, and that accessing this demo is lawful in your jurisdiction.
