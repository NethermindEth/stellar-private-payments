...
//! # Procedure
//!
//! After [`crate::chain::tx_prepare`] simulates a contract call,
//! [`PreparedSorobanTx`] holds an unsigned v1 envelope plus base64 auth entries
//! from recording-mode simulation. Signing completes two steps (see
...
mod tests {
    use super::*;
    use crate::chain::tx_assemble::test_fixtures;
