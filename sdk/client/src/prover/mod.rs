...
use types::{DISCLOSURE_RECEIPT_VERSION, DisclosurePublicInputs, DisclosureReceipt};
...
impl ProverEngine {
    ...
    pub(crate) fn prove_disclosure(
        ...
        let proved = disclosure::prove_receipt_proof_with_prover(&self.prover, &witness_bytes)?;
        let vk_hash = disclosure::vk_hash_hex(&self.prover.get_verifying_key()?);
