...
export const StateManager = {
     ...
     * Opens the database, detects RPC retention window, and initializes all stores.
...
// Pool store facade used by UI transaction modules.
export const poolStore = {
    getRoot: () => StateManager.getPoolRoot(),
    getMerkleProof: (i) => StateManager.getPoolMerkleProof(i),
    getNextIndex: () => StateManager.getPoolNextIndex(),
    getLeafCount: () => wasm().get_pool_leaf_count(),
};
