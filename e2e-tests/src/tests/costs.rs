...
const EXPECTED: &[(&str, u32, u32)] = &[
    ("pool transact, deposit, blocklist, fresh tree", 17, 6),
    ("pool transact, transfer, blocklist, fresh tree", 13, 4),
    ("pool transact, withdrawal, blocklist, fresh tree", 16, 6),
    ("pool transact, transfer, root one transaction old", 13, 4),
    (
    ...
    ("pool get_root", 2, 0),
    ("pool-gvk transact, transfer, view-only", 15, 4),
...
const EXPECTED_REAL_PROOF: (u32, u32) = (16, 4);
