...
struct CeremonyArgs {
    ...
    /// `policy_tx_2_2_both.r1cs` from the Cargo build output directory.
...
struct ExportDeploymentArgs {
    ...
    #[arg(long = "basename", default_value = "policy_tx_2_2_both")]
    basename: String,
...
const DEFAULT_R1CS_NAME: &str = "policy_tx_2_2_both.r1cs";
